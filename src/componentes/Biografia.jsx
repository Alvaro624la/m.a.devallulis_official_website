...
function Biografia() {
  ...
  <h1 style={{display: 'none'}}>Biografía y vida personal y músical de Miguel Angel de Vallulis</h1>
  <div className='biografia-body'>
    ...
    <div className='biografia-body__texto-container'>
      ...
      <p>
        ...
        <br/>
        En infinidad de ocasiones, su madre Victorina, agotada ya su infinita paciencia, le tenía que pedir con un “calla hijo, calla por favor”, que diera un poco de tregua a sus mañanas de cocina y cacharros. Más tarde, eran las familias de veraneantes quienes le subían a la mesa de la cocina pidiéndole que cantara...
        <br/>
        A los doce, ya en los Maristas de Carrión de los Condes, los hermanos enseguida descubren de sus dotes de canto y escenario, y le hacen protagonista en muchas de las obras de teatro e intérprete de canciones que representaba en el sala de teatro del colegio. Luego, algunas de esas canciones, las interpretó subido en los escenarios de la fiesta mayor de la ciudad.
        <br/>
        <br/>
        ...
        <br/>
        Ya en Barcelona, sigue tomando clases solfeo, de guitarra y de armonía. Busca en los anuncios de las tiendas de música aquellos en los que grupos buscan cantante. Así forma su primer grupo con el que ensaya en el Centro Social del barrio de Gracia. Logran actuar en las calles del barrio en la fiesta mayor. A partir de esos eventos, lo solicitan para formar parte de la primera de las orquesta de las varias en las que estuvo y con las que recorrió fiestas mayores en poblaciones de Cataluña, Andorra, Aragón y Castilla. Mucho más adelante, ya de bien adulto, hará unos años de piano logrando, con mucho esfuerzo, alcanzar un nivel suficiente que le permitiera enhebrar las melodías y armonías de estas canciones que hoy podemos escuchar.
      </p>
    </div>
  </div>
  </>
